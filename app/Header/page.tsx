...
export default function Header() {
  ...
  return (
    <header className="heel text-white py-2 relative">
      <div
        className="hel absolute top-0 left-0 w-[300px] h-[300px] rounded-full 
        blur-[100px] bg-primary-gradient1 -z-10"
      ></div>
      <div
        className="hel absolute top-0 right-0 w-[700px] h-[700px] rounded-full 
        blur-[100px] bg-primary-gradient2 -z-10"
      ></div>
      <div
        className="hel absolute top-0 bottom-0 w-[500px] h-[500px] rounded-full 
      ...
      <div className="flex pt-6 flex-col lg:flex-row items-center justify-between px-[8%] lg:px-[8%]">
        <div className="lg:w-1/2 text-start md:text-left">
          ...
          <h1 className="text-5xl text-start lg:text-6xl font-unbounded font-normal mb-2">
            Hi, I'm <span className="spancol">Divinedestiny Ekwom</span>
          </h1>
          <p className="text-gray-400 text-md lg:text-xl font-normal font-sora my-8">
            ...
            from portfolio sites, Python libraries, and MERN stack applications
            to gaming and 3D experiences. My work combines speed, precision, and
            clean design to deliver results that works — on time, every time.
          </p>
        ...
        <div className="lg:w-1/2 w-full mt-10 lg:mt-0 flex justify-center relative">
          <div className="relative rounded-full flex items-center justify-center">
            <div
              className="relative hero-image w-full h-full rounded-full overflow-hidden
              heroy"
            >
              <Image
                alt="PortPicture"
